      ...
      <main className="max-w-5xl mx-auto px-6 py-8">
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          <p style={{ fontSize: 15, color: colors.textMuted, maxWidth: 640 }}>
            We find who is really running Google Ads on your keywords, pull their
            live creatives from the Google Ads Transparency Center, read the copy,
            campaigns and landing pages behind them, and turn it into a clear plan
            of what to do next. You don&apos;t have to set anything — just press start.
          </p>
        </div>
...
function ReportView({ colors, report }: { colors: Colors; report: BenchmarkReport }) {
  ...
  return (
    <div style={{ marginTop: 24 }}>
      ...
      {/* ===== Live competitor ad teardown (the strategist report) ===== */}
      {report.adIntelligence?.markdown && (
        <div
          style={{
            marginTop: 20,
            padding: 22,
        ...
        >
          <h2 style={{ ...sectionTitle, marginTop: 0 }}>🕵️ Competitor ad teardown</h2>
          <p style={{ fontSize: 13.5, color: colors.textMuted, marginTop: -8, marginBottom: 14 }}>
            The real ads your competitors are running right now, pulled live from
            Google&apos;s Transparency Center and the paid search results, read and
            turned into a plan.
          </p>
          <MarkdownReport markdown={report.adIntelligence.markdown} colors={colors} />
          <div style={{ marginTop: 14, paddingTop: 12, borderTop: `1px solid ${colors.border}`, fontSize: 11.5, color: colors.textFaint }}>
            Generated by {report.adIntelligence.generatedBy}
          </div>
        </div>
      )}
