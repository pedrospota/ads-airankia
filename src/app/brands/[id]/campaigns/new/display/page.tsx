...
// Display (image/banner) campaign creator. Moved here from campaigns/new so
// that campaigns/new/display and campaigns/new/search are clear siblings.
export default async function NewDisplayCampaignPage({ params }: { params: Promise<{ id: string }> }) {
